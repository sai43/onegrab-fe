      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" className="text-text-gray hover:text-text-black">
              Login
            </Button>
            <Button className="bg-accent text-text-black hover:bg-accent-yellow transition-colors duration-200">
              Sign Up
            </Button>
          </div>
